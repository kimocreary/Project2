  ...
  var colors = {
      ...
      theme: {
        primary: style.getPropertyValue("--primary")
          ? style.getPropertyValue("--primary").replace(" ", "")
          : "#6e00ff",
        info: style.getPropertyValue("--info")
          ? style.getPropertyValue("--info").replace(" ", "")
          : "#00B8D9",
        success: style.getPropertyValue("--success")
          ? style.getPropertyValue("--success").replace(" ", "")
          : "#36B37E",
        danger: style.getPropertyValue("--danger")
          ? style.getPropertyValue("--danger").replace(" ", "")
          : "#FF5630",
        warning: style.getPropertyValue("--warning")
          ? style.getPropertyValue("--warning").replace(" ", "")
          : "#FFAB00",
        dark: style.getPropertyValue("--dark")
          ? style.getPropertyValue("--dark").replace(" ", "")
          : "#212529"
      },
