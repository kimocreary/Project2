  var crudApp = new function () {
            ...
            for (var j = 0; j < this.col.length; j++) {
                ...
                if (j >= 1) {
                    ...
                    if (j == 3) {   // WE'LL ADD A DROPDOWN LIST AT THE SECOND COLUMN (FOR Category).
                        ...
                        var select = document.createElement('input');      // CREATE AND ADD A DROPDOWN LIST.
        ...
        this.Update = function (oButton) {
            ...
            for (i = 1; i < 4; i++) {
                if (i == 3) {
                    var td = tab.getElementsByTagName("td")[i];
                    var ele = document.createElement('input');      // DROPDOWN LIST.
        ...
        this.Save = function (oButton) {
            ...
            for (i = 1; i < this.col.length; i++) {
                var td = tab.getElementsByTagName("td")[i];
                if (td.childNodes[0].getAttribute('type') == 'text' || td.childNodes[0].getAttribute('type') == 'date') {  // CHECK IF ELEMENT IS A TEXTBOX OR SELECT.
